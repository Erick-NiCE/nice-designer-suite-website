...
/** The subset of a target's props `Tooltip` reads and rewrites. */
interface TooltipTargetProps {
  className?: string;
  style?: CSSProperties;
  'data-lynn-tooltip'?: string;
  'data-lynn-tooltip-side'?: string;
}
...
export function Tooltip(props: TooltipProps) {
  ...
  const attributes: TooltipTargetProps = {
  ...
  return (
    <span className={classes} style={style} tabIndex={0} {...attributes}>
      {children}
    </span>
  );
}
